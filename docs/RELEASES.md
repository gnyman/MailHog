...
### [v1.0.0](https://github.com/gnyman/MailBoar/releases/v1.0.0)
...
- #136 - update MailBoar-UI assets, thanks @sdurrheimer
...
### [v0.2.1](https://github.com/gnyman/MailBoar/releases/v0.2.1)
...
- #93 - starting MailBoar as a service using brew, thanks @espen
...
### [v0.2.0](https://github.com/gnyman/MailBoar/releases/v0.2.0)
...
### [v0.1.9](https://github.com/gnyman/MailBoar/releases/v0.1.9)
...
### [v0.1.8](https://github.com/gnyman/MailBoar/releases/v0.1.8)
- Add `MailBoar sendmail` shortcut to `mhsendmail`
...
### [v0.1.7](https://github.com/gnyman/MailBoar/releases/v0.1.7)
...
### [v0.1.6](https://github.com/gnyman/MailBoar/releases/v0.1.6)
- Fix #24 - base64 attachments/mime part downloads
- Fix #28 - embed js/css/font assets for offline use
- Fix #29 - overview of MailBoar for readme
...
### [v0.1.5](https://github.com/gnyman/MailBoar/releases/v0.1.5)
- Fix mailhog/MailHog-UI#3 - squashed subject line

### [v0.1.4](https://github.com/gnyman/MailBoar/releases/v0.1.4)
...
### [v0.1.3](https://github.com/gnyman/MailBoar/releases/v0.1.3)
- Fix #22 - render non-multipart messages with HTML content type
- Fix #25 - make web UI resource paths relative

### [v0.1.2](https://github.com/gnyman/MailBoar/releases/v0.1.2)
...
### [v0.1.1](https://github.com/gnyman/MailBoar/releases/v0.1.1)
...
### [v0.1.0](https://github.com/gnyman/MailBoar/releases/v0.1.0)
...
### [v0.09](https://github.com/gnyman/MailBoar/releases/0.08)

- Fix #8 - add Chaos Monkey ([Jim](JIM.md)) to support failure testing

### [v0.08](https://github.com/gnyman/MailBoar/releases/0.08)
...
### [v0.07](https://github.com/gnyman/MailBoar/releases/tag/0.07)

- Fix #6 - Make SMTP verbs case-insensitive

### [v0.06](https://github.com/gnyman/MailBoar/releases/tag/0.06)

- Fix #5 - Support leading tab in multiline headers

### [v0.05](https://github.com/gnyman/MailBoar/releases/tag/0.05)

- Add #4 - UI support for RFC2047 encoded headers

### [v0.04](https://github.com/gnyman/MailBoar/releases/tag/0.04)
...
### [v0.03](https://github.com/gnyman/MailBoar/releases/tag/0.03)
...
### [v0.02](https://github.com/gnyman/MailBoar/releases/tag/0.02)
...
### [v0.01](https://github.com/gnyman/MailBoar/releases/tag/0.01)
